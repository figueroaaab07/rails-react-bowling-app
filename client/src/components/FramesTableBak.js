...
function FramesTable({ game, result }) {
      ...
      <div className='Container'>
        <table id='table' className='Scorecard' cellPadding='1' cellSpacing='0'>
          <tbody>
            ...
            <tr>
              <td id='r1' colSpan='3'>{game[0][0]}</td><td id='r2' colSpan='3'>{game[0][1]}</td>
              <td id='r3' colSpan='3'>{game[1][0]}</td><td id='r4' colSpan='3'>{game[1][1]}</td>
              <td id='r5' colSpan='3'>{game[2][0]}</td><td id='r6' colSpan='3'>{game[2][1]}</td>
              <td id='r7' colSpan='3'>{game[3][0]}</td><td id='r8' colSpan='3'>{game[3][1]}</td>
              <td id='r9' colSpan='3'>{game[4][0]}</td><td id='r10' colSpan='3'>{game[4][1]}</td>
              <td id='r11' colSpan='3'>{game[5][0]}</td><td id='r12' colSpan='3'>{game[5][1]}</td>
              <td id='r13' colSpan='3'>{game[6][0]}</td><td id='r14' colSpan='3'>{game[6][1]}</td>
              <td id='r15' colSpan='3'>{game[7][0]}</td><td id='r16' colSpan='3'>{game[7][1]}</td>
              <td id='r17' colSpan='3'>{game[8][0]}</td><td id='r18' colSpan='3'>{game[8][1]}</td>
              <td id='r19' colSpan='2'>{game[9][0]}</td><td id='r20' colSpan='2'>{game[9][1]}</td><td id='r21' colSpan='2'>{game[9][2]}</td>
